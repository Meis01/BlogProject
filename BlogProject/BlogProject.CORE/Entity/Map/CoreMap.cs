...
namespace BlogProject.CORE.Entity.Map
{
    ...
    {
        public virtual void Configure(EntityTypeBuilder<T> builder) // virtual (Configure metot ezmesi lazım)
        {
            ...
            builder.Property(x => x.ModifiedComputerName).HasMaxLength(15).IsRequired(false);
